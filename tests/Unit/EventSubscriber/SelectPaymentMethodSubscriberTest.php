...
namespace Setono\SyliusPlausiblePlugin\Tests\Unit\EventSubscriber;
...
final class SelectPaymentMethodSubscriberTest extends TestCase
{
    ...
    public function it_logs_error_when_exception_is_thrown(): void
    {
        ...
        $logger->error(\Prophecy\Argument::containingString('Select Payment Method'), \Prophecy\Argument::withEntry('exception', \Prophecy\Argument::type(\Throwable::class)))->shouldBeCalled();
